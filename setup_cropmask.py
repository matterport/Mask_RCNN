...
logging.warning(" Activate and install geo-environment.yml requirements prior to installing cropmask! Need to figure how to trigger install of requirements in the .yml file.")
install_reqs = []
setup(
        name="cropmask",
        version="0.0.1",
