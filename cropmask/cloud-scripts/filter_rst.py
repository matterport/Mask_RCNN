...
reclass(
    "<", out_path + "max7x7.rst", out_path + "Shadow_and_Water.rst", 2000
)  # specify threshold for shadow and water

# 4. Cloud, and to disk
reclass(
    ">", out_path + "min7x7.rst", out_path + "Cloud.rst", 2000
...
cloud_shadow(
    out_path + "Cloud.rst", out_path + "Shadow.rst", out_path + "Cloud_Shadow.rst"
)
