...
reclass("<", out_path + "max7x7.tif", out_path + "Shadow_and_Water.tif", 2000) #specify threshold for shadow and water

#4. Cloud, and to disk
reclass(">", out_path + "min7x7.tif", out_path + "Cloud.tif", 2000) #specify threshold for cloud
...
cloud_shadow(out_path + "Cloud.tif", out_path + "Shadow.tif", out_path + "Cloud_Shadow.tif")
