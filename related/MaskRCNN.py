...
#         y_max, x_max, channels = self.bg[index].shape
#         y_max, x_max,channels = cv2.imread(self.bg[index],mode='RGB').shape
...
model_path = os.path.join(ROOT_DIR, "logs/mask_rcnn_shapes_17.h5")
...
t = cv2.cvtColor(cv2.imread('/Users/AsherYartsev/Desktop/coffeeleaf.jpeg'), cv2.COLOR_BGR2RGB)
