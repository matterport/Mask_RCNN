...
def TACO_category_mapping(old_category):
    ...
    to_plastic = ['Clear plastic bottle', 'Other plastic bottle', 'Plastic bottel cap', 'Disposable plastic cup', 
                  ...
                  'Polypropylene bag', 'Produce bag', 'Cereal bag', 'Plastic film', 'Crisp packet', 'Other plastic wrapper',
                  'Spread tub', 'Tupperware', 'Disposable food container', 'Foam food container', 'Other plastic container',
    ...
    if old_category in to_plastic: return 'plastic'
    elif old_category in to_cardboard: return 'cardboard'
    elif old_category in to_paper: return 'paper'
    elif old_category in to_metal: return 'metal'
    elif old_category in to_glass: return 'glass'
    else: return 'trash'
