...
If you are not able to create your own JSON file from your own dataset, you can find a way here : https://github.com/samelsamel/creation_of_mask_rcnn_json_file
