...
class MaskRCNN():
    ...
    def build(self, mode, config):
        ...
        # we apply (1,1) convolution to reduce huge number of filters from C5 into a fixxed size.
        ...
        with tf.variable_scope("RPN"):
            ...
            # rpn_class_logits are the values before softmax and rpn_class are the probs after softmax
        ...
        if mode == "training":
            ...
            # asher todo: naming scopes for the rest!
            # Network Heads
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        self.keras_model.fit_generator(
            ...
            validation_steps=self.config.VALIDATION_STEPS / self.config.BATCH_SIZE,
            max_queue_size=10,
            workers=1,
