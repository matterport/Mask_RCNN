    ...
    def get_imagenet_weights(self,no_top=True):
        ...
        if no_top:
            if self.config.BACKBONE == "resnet50":
                ...
                weights_path = get_file('mobilenet_v2_weights_tf_dim_ordering_tf_kernels_1.0_224_no_top.h5',
                                        TF_WEIGHTS_PATH,
                                        cache_subdir='models')
        else:
            if self.config.BACKBONE == "mobilenetv1":
                ...
                weights_path = get_file('mobilenet_v2_weights_tf_dim_ordering_tf_kernels_1.0_224.h5',
                                        TF_WEIGHTS_PATH,
                                        cache_subdir='models')
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        callbacks = [
            ...
            keras.callbacks.ModelCheckpoint(self.checkpoint_path,
                                            verbose=0, save_weights_only=True, save_best=self.config.save_best_only),
        ]
