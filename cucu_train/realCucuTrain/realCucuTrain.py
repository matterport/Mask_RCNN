...
MODEL_DIR = os.path.join(ROOT_DIR, "cucu_train/weightsAndGraphs/realImagesWeights/")
...
class cucumberDataset(utils.Dataset):
    ...
    def load_cucumber(self, dataset_dir, subset):
        ...
        annotations = json.load(open(os.path.join(dataset_dir, "segmentation_results.json")))
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a cucumber dataset image, delegate to parent class.
